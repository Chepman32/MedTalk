...
import priceLabel from "../assets/icons/price.png"
...
export const Head = ({ title, image, isFavorite, showModal, showContactsModal, showScheduleModal, onPricePress }) => {
    ...
    <View style={styles.container} >
          ...
          <Image style={styles.image} source={MockImage} />
            ...
            <View>
              ...
              <Stars rating={4} onPress={showModal}/>
              <View style={styles.row}>
                ...
                <Image style={styles.icon} source={geo} />
                            {
                                onPricePress && <TouchableOpacity onPress={onPricePress}>
                                <Image style={styles.icon} source={priceLabel} />
                              </TouchableOpacity>
                }
              </View>
                </View>
