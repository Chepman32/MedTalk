...
export const DentistsItem = ({ text, icon, type, isFavorite }) => {
  const [favorite, setFavorite] = useState(isFavorite);

  const navigation = useNavigation();

  return (
    <TouchableOpacity style={styles.container} onPress={() => navigation.navigate('DentistDetails')} >
      <Text style={styles.title}>Стоматология “Dental Center”</Text>
      ...
      <View style={styles.footer} >
        ...
        <Text style={styles.text}>Чистка зубов, Протезирование зубов, ...</Text>
      </View>
    </TouchableOpacity>
  );
};
