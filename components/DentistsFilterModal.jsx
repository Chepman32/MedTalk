...
export const DentistsFilterModal = ({ isModalVisible, hide }) => {
   ...
   >
     <View style={styles.modalContent}>
       ...
       <View>
         ...
         <CustomDropdown selected={selectedService} handleSelect={(value) => setSelectedService(value)} options={options}/>
